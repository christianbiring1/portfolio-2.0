...
// Updated experiences with work type
const experiences = [
  {
    id: 1,
    company: "eFiche",
...
// Helper function to get work type badge variant and color
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-start gap-3">
                          <motion.div
                            whileHover={{ rotate: 360 }}
                            transition={{ duration: 0.5 }}
                            className={`flex items-center justify-center h-10 w-10 rounded-xl bg-gradient-to-br ${exp.color} text-white shadow-lg flex-shrink-0`}
                          >
                            <Briefcase className="h-5 w-5" />
                          </motion.div>
                          <div className="flex-1 min-w-0">
                            ...
                            <CardDescription className="text-sm font-medium text-muted-foreground flex items-center gap-1 mt-1">
                        ...
                        {/* Time and Work Type Row - Responsive */}
                          ...
                          <div className="flex items-center gap-1.5 self-start sm:self-center">
                            ...
                            <Badge
                              className={`text-xs font-medium transition-colors duration-300 ${
                                getWorkTypeBadge(exp.workType).color
                              }`}
                            >
                              {exp.workType}
                            </Badge>
